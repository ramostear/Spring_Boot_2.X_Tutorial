...
/**
 * @author ramostear
 * @create-time 2019/5/19 0019-14:53
 * @modify by :
 * @since:
 */
@Slf4j
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        apiError.addRestApiValidationErrors(ex.getBindingResult().getFieldErrors());
        apiError.addRestApiValidationError(ex.getBindingResult().getGlobalErrors());
        return buildResponseEntity(apiError);
    }
    ...
    protected ResponseEntity<Object> handleConstraintViolation(
        ...
        RestApiError apiError = new RestApiError(BAD_REQUEST);
        apiError.setMessage("Validation error");
        apiError.addRestApiValidationErrors(ex.getConstraintViolations());
        return buildResponseEntity(apiError);
    }
